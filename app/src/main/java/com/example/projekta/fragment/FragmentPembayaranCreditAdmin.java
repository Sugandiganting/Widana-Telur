...
import com.example.projekta.adapter.ACreditAdmin;
...
public class FragmentPembayaranCreditAdmin extends Fragment implements DatePickerDialog.OnDateSetListener {
    View v;
    private Api_Rest apiRest;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private MaterialSpinner lstCustomer;
    private ACreditAdmin aPandingAdmin;
    ...
    public FragmentPembayaranCreditAdmin(Context context){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.pembayarn_credit_admin_fragment,container,false);
        apiRest = Common.getApi();
        recyclerView = v.findViewById(R.id.creditAdmin_rv);
        lstCustomer = v.findViewById(R.id.cb_namaUserCA);
        btn_tanggal = v.findViewById(R.id.btn_tanggalPengirimanCA);
        btn_search = v.findViewById(R.id.btn_cariCA);
        btn_refresh = v.findViewById(R.id.btn_refreshCA);
        tv_tanggal = v.findViewById(R.id.tv_tanggalPengirimanCA);
    ...
    private void search() {
        if (validasi()==true){
            ...
            apiRest.searchkreditadmin(scustomer_id,stanggal).enqueue(new Callback<List<MPandingAdmin>>() {
                @Override
                public void onResponse(Call<List<MPandingAdmin>> call, Response<List<MPandingAdmin>> response) {
                    if (response.body()!=null){
                        ...
                        aPandingAdmin = new ACreditAdmin(v.getContext(), mPandingAdmins);
    ...
    private void loadListCreditAdmin() {
        apiRest.listcreditadmin().enqueue(new Callback<List<MPandingAdmin>>() {
            @Override
            public void onResponse(Call<List<MPandingAdmin>> call, Response<List<MPandingAdmin>> response) {
                if (response.body()!=null){
                    List<MPandingAdmin> mPandingAdmins = response.body();

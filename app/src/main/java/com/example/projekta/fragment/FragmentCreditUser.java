...
public class FragmentCreditUser extends Fragment implements DatePickerDialog.OnDateSetListener {
    View v;
    private Api_Rest apiRest;
    private Context context;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private ACreditUser aPandingAdmin;
    ...
    private String id_user,status="3";
    User user = new User();

    public FragmentCreditUser(Context context){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.credit_user_fragment, container, false);

        apiRest = Common.getApi();
        user = User.findById(User.class, (long) 1);
        id_user = user.getId_user();
        recyclerView = v.findViewById(R.id.creditUser_rv);
        lstCustomer = v.findViewById(R.id.cb_namaUserU);
        btn_tanggal = v.findViewById(R.id.btn_tanggalPengirimanU);
        btn_search = v.findViewById(R.id.btn_cariU);
        btn_refresh = v.findViewById(R.id.btn_refreshU);
        tv_tanggal = v.findViewById(R.id.tv_tanggalPengirimanU);
    ...
    private void loadListCreditUser() {
        apiRest.listcredituser(id_user,status).enqueue(new Callback<List<MPandingAdmin>>() {
            ...
            public void onResponse(Call<List<MPandingAdmin>> call, Response<List<MPandingAdmin>> response) {
                if (response.body()!=null){
                    ...
                    aPandingAdmin = new ACreditUser(v.getContext(), mPandingAdmins);

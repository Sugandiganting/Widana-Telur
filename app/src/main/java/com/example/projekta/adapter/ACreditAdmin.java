...
public class ACreditAdmin extends RecyclerView.Adapter<ACreditAdmin.ViewHolder> {
    ...
    public ACreditAdmin(Context context, List<MPandingAdmin> pandingAdminList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = inflater.inflate(R.layout.item_credit_admin, viewGroup, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tv_noTransaksi = itemView.findViewById(R.id.tv_noTransaksiCA);
            tv_tglPengiriman = itemView.findViewById(R.id.tv_tglPengirimanCA);
            tv_total = itemView.findViewById(R.id.tv_totalCA);
            tv_user = itemView.findViewById(R.id.tv_userCA);
            tv_noHp = itemView.findViewById(R.id.tv_noHpCA);
            tv_alamatPengiriman = itemView.findViewById(R.id.tv_alamatPengirimanCA);
            tv_biayaJasa = itemView.findViewById(R.id.tv_biayaJasaCA);
            tv_uangDp= itemView.findViewById(R.id.tv_uangDpCA);
            tv_sisaPembayaran = itemView.findViewById(R.id.tv_sisaPembayaranCA);
            tv_tanggalPenagihan = itemView.findViewById(R.id.tv_batasPembayaranCA);
            tv_kurir = itemView.findViewById(R.id.tv_kurirMengantarCA);
            btn_detail = itemView.findViewById(R.id.btn_detailCA);
        }
    }
}
